...
\backgroundsetup{contents={MAGELLAN}}
...
%%自定义封面
\def\titlename{Magellan}
\def\subtitle{A Simple xUnit Test Framework in Modern C++11}
\def\authors{刘光聪}
...
\input{contents/test_case.tex}
\input{contents/assertion.tex}
